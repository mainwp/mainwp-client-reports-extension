 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
// fix bug absolute path
$creport_image_path = apply_filters( 'mainwp_getspecificdir', 'client_report' );
//$path = explode("/uploads/mainwp/", $creport_image_path);
//$path = $path[1];
//define ('K_PATH_IMAGES', dirname(__FILE__).'/../../../uploads/mainwp/' . $path);
define( 'K_PATH_IMAGES', $creport_image_path );
